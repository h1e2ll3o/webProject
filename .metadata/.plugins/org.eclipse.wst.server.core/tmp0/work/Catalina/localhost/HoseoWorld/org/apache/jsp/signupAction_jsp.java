 ...
 * Generated at: 2020-12-07 10:30:19 UTC
...
public final class signupAction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("UserDatabase");
...
request.setCharacterEncoding("utf-8");
      ...
      user = (UserDatabase.User) _jspx_page_context.getAttribute("user", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (user == null){
        user = new UserDatabase.User();
        _jspx_page_context.setAttribute("user", user, javax.servlet.jsp.PageContext.PAGE_SCOPE);
      }
      out.write('\r');
      out.write('\n');
      UserDatabase.UserBean userbean = null;
      userbean = (UserDatabase.UserBean) _jspx_page_context.getAttribute("userbean", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (userbean == null){
        userbean = new UserDatabase.UserBean();
	...
	if(userbean.check_id(id)==1){
      ...
      out.write("<script>alert('입력오류');history.back(-1);</script>");

		}
	} else if(userbean.check_id(id)==0){
		
      out.write("<script>alert('아이디 중복');history.back(-1);</script>");
